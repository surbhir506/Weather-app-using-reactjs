        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <Box p={'10px'}>
                            <Box p={'5px'} bg={'#35155D'} textAlign={'center'} borderRadius={'30px'} mb={'20px'} >
