        ...
        <>
            <Box maxW={'1400px'} m={'20px auto 5px'} p={'20px'} minH={'550px'}>
                <Grid gridTemplateColumns={['100%', 'repeat(2, 1fr)', 'repeat(2, 1fr)', '30% 27.5% 38%']} gap={'30px'}>
                    <Newbox>
                        <Box color={'#35155D'} p={'20px'} textAlign={'center'}>
                            <Flex justify={'end'}>
                                <Icon
                        ...
                        <Grid templateColumns={'50% 50%'} h={'100%'} p={'8px'}>
                            <Box py={'10px'} pl={'15%'}>
                                {['Felt Temp.', 'Humidity', 'Wind', 'Visibility', 'Max Temp.', 'Min Temp.'].map((e, i) => (
                                    <Text key={i} color={'#35155D'} fontWeight={500} mt={'15px'} fontSize={'18px'} >{e}</Text>
                                ))}
                            </Box>
                            <Box borderRadius={'30px'} bg={'#35155D'} py={'10px'} pl={'15%'}>
                ...
                <div className="tagLine">
                    <p id="madeBySurbhi">Made with ❤️ by <a href="https://github.com/surbhir506/">Surbhi Ranjan</a></p>
                </div>
            </Box >
        </>
    );
